...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .badge-pending, .badge-allapi_pending{background-color:#f59e0b;} /* Added allapi_pending */
        ...
        .badge-bonus{background-color:#059669;} /* Added for bonus */
        .badge-loan{background-color:#3b82f6;}
        .badge-eligible_for_bonus{background-color:#3b82f6;} /* Added for refer */
        ...
        [data-theme="dark"] .grid-services .service-button {
            border: 1px solid rgba(255,255,255,0.2);
            background: rgba(255,255,255,0.05);
        }
        .grid-services .service-button:hover {
...
<body data-theme="light">
    <div class="header">
        <div class="brand">
            ...
            <div>
                ...
                <div class="small">buy gold • shop • wallet</div>
            </div>
        </div>
        <div class="top-right" style="display:flex;align-items:center;gap:12px">
            <div class="small" id="goldrate-display">rate: ₹6500 / g</div>
            <div class="small" id="wallet-mini">wallet: ₹0</div>
    ...
    <div class="search-bar">
        ...
        <!-- category-filter for home page search. Keep it synchronized with cat-shop-filter. -->
        <select id="category-filter" onchange="applyFilter()">
            <option value="">all categories</option>
        </select>

        <!-- cat-shop is removed as it was redundant, cat-shop-filter is used for actual shop page filtering -->
        <!-- <select id="cat-shop">
            <option value="">all categories</option>
        </select> -->
    ...
    <div class="container">
            ...
            <div class="card gold-box">
                <div style="display:flex;justify-content:space-between;align-items:center">
                    <div>
                        ...
                        <div class="balance-display">₹ <span id="gold-rate">6500</span> / g</div>
        ...
        <div id="shop" class="section">
            ...
            <div class="card">
                <div style="display:flex;gap:8px;align-items:center">
                    ...
                    <select id="cat-shop-filter" style="min-width:140px" onchange="searchShop(true)"><option value="">all categories</option></select>
                    <button class="btn" onclick="searchShop(true)">search</button>
                </div>
            </div>
        ...
        <div id="cart" class="section">
            ...
            <div style="margin-top:12px">
                <div class="card">
                    ...
                    <div style="margin-top:8px" class="small-muted">Delivery address will be confirmed at checkout.</div>
                </div>
            </div>
        </div>
        ...
        <div id="gold" class="section">
            ...
            <div class="card gold-box">
                ...
                <div class="note" style="margin-top:4px;">(equivalent to: ₹<span id="gold-value-main">0</span>)</div>
            </div>
            <div class="card" style="margin-top:12px;">
                <h4 style="margin-top:0;">purchase gold</h4>
                <div style="flex:1">
                    <label class="small">enter amount (₹, min 50)</label>
                    <input id="gold-amount" type="number" placeholder="amount in ₹">
                    <div class="note small" style="margin-bottom:8px;">will get: <strong id="gold-grams-calc">0.0000 g</strong></div>
                </div>
                <div style="margin-top:12px;display:flex;gap:8px">
                    <button class="btn" onclick="buyGold()">Pay Now</button>
                    <button class="btn secondary" onclick="showHistory('gold')">my gold history</button>
                </div>
                <div class="small-muted" style="margin-top:10px;">Click "Pay Now" to proceed with payment via UPI/Netbanking.</div>
            </div>
        ...
        <div id="wallet" class="section">
            ...
            <div class="card gold-box">
                ...
                <div class="balance-display">₹ <span id="wallet-balance-main">0</span></div>
            </div>
            <div class="card" style="margin-top:12px">
                ...
                <div style="flex:1">
                    ...
                    <div style="display:flex;gap:8px;margin-top:8px">
                        <button class="btn" onclick="addWallet()">Pay to Add Money</button>
                        <button class="btn secondary" onclick="openWithdrawModal()"><i class="ri-bank-card-line"></i> withdraw</button>
                    </div>
                    <div class="small-muted" style="margin-top:10px;">Click "Pay to Add Money" to proceed with payment via UPI/Netbanking.</div>
                </div>
            </div>
        ...
        <div id="profile" class="section">
                    ...
                    <div id="profile-view">
                        <div style="display:flex;gap:8px;align-items:center">
                            <div style="flex:1">
                                ...
                                <div id="profile-email-display" class="small-muted">Email</div>
                            </div>
                            <div>
            ...
            <h1 class="text-3xl font-extrabold text-center mb-8 text-gray-800">उपलब्ध सेवाएँ (Available Services)</h1>
            ...
            <div class="card" style="margin-top:12px">
                ...
                <div id="kyc-block">
                    <!-- KYC form or status will be rendered here -->
                </div>
            </div>
            ...
            <div class="card" style="margin-top:12px">
                ...
                <p class="small-muted">terms: referred friend must buy gold ≥ ₹50. only first friend counts. admin approval required.</p>
            ...
            <div class="card" style="margin-top:12px">
                <h3 style="margin-top:0;">chat support 💬</h3>
            ...
            <div id="orders-full-list" style="margin-top:16px;">
                <!-- Full order list will be rendered here -->
                </div>
        </div>
    </div>
    ...
    <div id="checkout-overlay" class="overlay">
        <div class="modal">
            ...
            <div style="display:flex;gap:8px;margin-top:16px">
                <button class="btn" onclick="confirmCheckout()"><i class="ri-check-line"></i> Proceed to Pay</button>
                <button class="btn secondary" onclick="closeCheckoutModal()">Cancel</button>
            </div>
            <div class="small-muted" style="margin-top:10px;">Click "Proceed to Pay" to finalize your order and initiate payment via allapi.in.</div>
        </div>
    </div>
    ...
    <div id="withdraw-overlay" class="overlay">
        <div class="modal">
            ...
            <div>
                <label class="small">Amount (Current Balance: ₹<span id="withdraw-balance">0</span>)</label>
    ...
    <div id="loan-overlay" class="overlay">
        <div class="modal">
            ...
            <label class="small">Loan Amount Needed (Min ₹500)</label>
    ...
    <div id="loan-action-overlay" class="overlay">
        <div class="modal" id="loan-action-modal">
            <!-- Loan action content will be dynamically loaded here -->
            </div>
    </div>
...
<script src="https://sdk.cashfree.com/js/v3/cashfree.js"></script>
    ...
    <script>
        ...
        // This is necessary to access user-specific data and potentially anonymous public data.
        auth.onAuthStateChanged(user => {
            if (user) {
                // If user is logged in, proceed with loading services
                currentUser = user; // Ensure currentUser is set
                loadServiceVisibilityListeners();
            } else {
                // If no user is logged in, attempt anonymous sign-in to access public data
                auth.signInAnonymously()
                    .then((result) => {
                        if (result && result.user) {
                            currentUser = result.user; // Set currentUser for anonymous user too
                            loadServiceVisibilityListeners();
                        }
                    })
                    .catch(error => {                                                                                                                          
...
// ==========================================
// ⭐ MASTER CHECKOUT (PURE CASHFREE)
// ==========================================
async function confirmCheckout() {
    try {
        if (!currentUser) return alert('Please login to complete checkout.');

        // 1. Get Address safely
        const houseEl = document.getElementById('co-addr-house');
        const cityEl = document.getElementById('co-addr-city');
        const distEl = document.getElementById('co-addr-district');
        const countEl = document.getElementById('co-addr-country');

        if (!houseEl || !cityEl || !distEl || !countEl) {
            return alert('Address fields not found on page.');
        }

        const house = houseEl.value.trim();
        const city = cityEl.value.trim();
        const district = distEl.value.trim();
        const country = countEl.value.trim();

        if (!house || !city || !district || !country) {
            return alert('Please fill all delivery address fields');
        }
        ...
        const customer = (typeof getUserProfileForPayment === 'function') ? getUserProfileForPayment() : { 
            customer_name: "User", 
            customer_mobile: "0000000000",
            customer_email: currentUser.email || ""
        };

        // 3. Save Address & Order to Firebase first (Safety)
...
admin_note: ${r.admin_note||'none'}`);
        ...
        function renderStatusBadge(status){
            ...
            const statusClass = {
                ...
                'allapi_pending': 'badge-allapi_pending', // NEW: Added for allapi.in
                ...
                'eligible_for_bonus': 'badge-eligible_for_bonus', // New status for refer
        ...
        function loadQuickHistory(){
            ...
            db.ref('users/'+currentUser.uid).once('value').then(snap=>{
                ...
                combined.forEach(item=>{
                    ...
                    let text = 'Activity';
                    if (type === 'order') text = `order ${item.id.substring(0,8)} • ₹${item.total} • ${item.items ? Object.keys(item.items).length + ' items' : '—'}`;
                    if (type === 'gold') text = `gold buy • ₹${item.amount} → ${Number(item.grams).toFixed(4)}g`;
                    if (type === 'add' || type === 'withdraw' || type === 'bonus' || type === 'loan_credit' || type === 'wallet') text = `${type.replace('_',' ')} • ₹${item.amount}`;
